...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "No data to display" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Showing results from _START_ to _END_ of a total of _TOTAL_",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtering a total of _MAX_ results)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "No results were found with this criterion"
		},
